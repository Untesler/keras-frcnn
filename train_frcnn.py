...
all_imgs, classes_count, class_mapping = get_data(options.train_path, 'train')
...
epoch_length = C.epoch_length #batch size
num_epochs = int(options.num_epochs) or C.num_epochs
iter_num = 0
